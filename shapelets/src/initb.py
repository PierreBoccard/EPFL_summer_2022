...
kwargs_lens_init = results4.get('kwargs_lens')
kwargs_source_init = results4.get('kwargs_source')
kwargs_lens_light_init = results4.get('kwargs_lens_light')
...
f.tight_layout()
f.savefig('initial2.jpg', dpi=150)
#plt.show()
plt.close()

f, axes = lensPlot.plot_main()
f.savefig('initial2a.jpg', dpi=150)
#plt.show()
plt.close()

f, axes = lensPlot.plot_separate()
f.savefig('initial2b.jpg', dpi=150)
#plt.show()
plt.close()

f, axes = lensPlot.plot_subtract_from_data_all()
f.savefig('initial2c.jpg', dpi=150)
#plt.show()
plt.close()
...
kwargs_lens_upper = [{'theta_E': 3., 'gamma': 2.2, 'e1': e1a,'e2':e2a,'center_x':xa,'center_y': ya},
...
kwargs_lens_lower = [{'theta_E':1., 'gamma': 1.30, 'e1': e1a,'e2':e2a,'center_x':xa,'center_y': ya},
...
kwargs_lens_fixed = [{'gamma' : 2, 'center_x': xa, 'center_y': ya},{'e1': 0, 'e2': 0, 'center_x': xb, 'center_y': yb},{'e1': 0, 'e2': 0, 'center_x': xc, 'center_y': yc},{'center_x': xd, 'center_y': yd},{'ra_0': 0, 'dec_0': 0}]

kwargs_source_fixed = [{},{'n_max': -1}]
